...
<div class="takeaway-grid">
  <div>
    <span>01</span>
    <p>Larger models form more differentiated emotion hierarchies.</p>
  </div>
  <div>
    <span>02</span>
    <p>Persona assumptions reshape emotion recognition in systematic ways.</p>
  </div>
  <div>
    <span>03</span>
    <p>Better emotion prediction can increase persuasive power in synthetic negotiations.</p>
  </div>
</div>
